 ...
 */
package client.clientModel.game;
...
import client.clientModel.board.Board;
import client.clientModel.board.Move;
import client.clientModel.pieces.Bishop;
import client.clientModel.pieces.King;
import client.clientModel.pieces.Knight;
import client.clientModel.pieces.Pawn;
import client.clientModel.pieces.Piece;
import client.clientModel.pieces.PieceImages;
import client.clientModel.pieces.Queen;
import client.clientModel.pieces.Rook;
...
public final class Game {
    ...
    public Game(Boolean side, GameController gameCtr) {
    ...
    public static void sendLossInfor() {
        ArrayList inf = new ArrayList();
        Message msg = new Message(Message.Message_Type.EnemyLoss);
        msg.content = inf;
        Client.Send(msg);
    }
